...
async function complete(color){
	// var idx=unChangeArray.indexOf(arr[0]);
	// console.log(idx);
	// console.log(arr);
	// var el=array[0];
...
async function sorted(){
	let ele=document.getElementById("sorted");
	...
	for (let i=0; i<50; i++){
		...
		let fs=30+2*i;
		await delay(0.01);
		ele.style.marginBottom=t+"px";
		ele.style.marginRight=l+"px";
